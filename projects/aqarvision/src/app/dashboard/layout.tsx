        ...
        <div className="flex border-t border-border overflow-x-auto scrollbar-hide">
          {liens.map((lien) => (
            <Link
              key={lien.href}
              href={lien.href}
              className="flex-shrink-0 flex flex-col items-center py-2 px-3 text-[10px] text-muted-foreground hover:text-foreground transition-colors"
            >
