...
export default async function LeadDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-8">
      <Link href="/dashboard/leads" className="mb-4 inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              {lead.properties && (
                <InfoRow
                  ...
                  href={`/dashboard/properties/${(lead.properties as { id: string }).id}/edit`}
                />
              )}
