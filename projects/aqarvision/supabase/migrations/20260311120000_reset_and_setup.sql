...
DO $$ BEGIN
  ...
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'agency_members' AND policyname = 'Agency owners and admins can manage members') THEN
    CREATE POLICY "Agency owners and admins can manage members" ON agency_members FOR ALL
      USING (
