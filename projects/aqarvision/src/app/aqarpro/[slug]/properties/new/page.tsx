...
export default function NewPropertyPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        router.push(`/aqarpro/${slug}/properties`);
      } else {
  ...
  return (
    <div className="mx-auto max-w-3xl p-6 lg:p-8">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-heading-lg text-neutral-900">Ajouter un bien</h1>
          <p className="text-body-sm text-neutral-500">Créez une nouvelle annonce immobilière</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div>
                ...
                <select id="transaction_type" name="transaction_type" required className={selectClass}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div>
                ...
                <input id="surface" name="surface" type="number" min={0} className={inputClass} />
              </div>
              <div>
                <label htmlFor="rooms" className={labelClass}>Pièces</label>
                <input id="rooms" name="rooms" type="number" min={0} className={inputClass} />
              </div>
              <div>
          ...
          <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select id="wilaya" name="wilaya" className={selectClass}>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div>
                ...
                <input id="city" name="city" type="text" className={inputClass} placeholder="Oran" />
              </div>
              <div>
                <label htmlFor="commune" className={labelClass}>Commune / Quartier</label>
                <input id="commune" name="commune" type="text" className={inputClass} placeholder="Bir El Djir" />
              </div>
              <div>
                <label htmlFor="address" className={labelClass}>Adresse</label>
                <input id="address" name="address" type="text" className={inputClass} placeholder="Rue, n°..." />
              </div>
            </div>
          </div>
        </Section>
        ...
        <div className="flex gap-3">
          <button
            type="submit"
            disabled={isPending}
            className="rounded-lg bg-primary-600 px-6 py-2.5 text-body-sm font-semibold text-white transition-colors hover:bg-primary-700 disabled:opacity-50"
          >
